...
<body>
	...
	<div class="boxcontacto">
		...
		<div class="center">
			...
			<ul>
				<form action="crearUsuarioEmpleado.php" method="post">
		            <fieldset style="width: 100px height: 250px" >
			<legend><h1>Añadir Empleado</h1></legend>
			<br>
			<label>Nombre:</label> 
				<br>
			...
			<label>Usuario:ㅤ</label>	<label>	ㅤㅤㅤㅤㅤㅤContraseña:ㅤㅤㅤㅤㅤㅤ</label>
			<br>
			...
			<br><br>
			<input type="submit" value="ㅤAñadirㅤ">
			<br><br>
		</fieldset>
        	</form>
					 <br>
